...
function handleLogout() {
    ...
    if (logoutBtn) {
        ...
        logoutBtn.innerHTML = '<span class="logout-icon">⏳</span><span class="logout-text">Logging out...</span>';
    }
    ...
    .then(data => {
        if (data.status === 'logout_successful') {
            ...
            if (logoutBtn) {
                logoutBtn.innerHTML = '<span class="logout-icon">✓</span><span class="logout-text">Logged out!</span>';
            }
