...
def test_duplicate_user():
    ...
    # Try duplicate
    response = requests.post(f"{BASE_URL}/api/users", json={"username": duplicate_username})
...
def test_database_operations():
    ...
    response1 = requests.post(f"{BASE_URL}/api/users", json={"username": test_username1})
    response2 = requests.post(f"{BASE_URL}/api/users", json={"username": test_username2})
